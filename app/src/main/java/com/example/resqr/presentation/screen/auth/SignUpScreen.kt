...
import com.example.resqr.domain.model.authModel.Roles
...
fun SignUp(navController: NavController) {
    ...
    SignUpScreenContent(authUiState.value, authViewModel, userViewModel, navController)
}
...
fun SignUpScreenContent(
    ...
    val phoneNumber = authViewModel.phoneNumber.collectAsState()
    val passwordConfirmation = authViewModel.passwordConfirmation.collectAsState()
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            onValueChange = { authViewModel.onPasswordConfirmationChange(it) },
            label = { Text("Password") },
            leadingIcon = {
                Icon(Icons.Default.Lock, contentDescription = null)
            },
